export function RockPaperScissors() {
  function startGame(mode) {
    if (mode === 'classic') {
      window.navigate('/games/rock-paper-scissors/classic'); // Classic Mode yönlendirmesi
    } else if (mode === 'advanced') {
      window.navigate('/games/rock-paper-scissors/advanced'); // Advanced Mode yönlendirmesi
    } else {
  ...
  function goBack() {
    window.navigate('/games'); // Oyunlar sayfasına dön
  }
