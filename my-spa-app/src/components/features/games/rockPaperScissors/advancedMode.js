...
export function AdvancedMode() {
    ...
    spriteSheet.src = '/src/assets/images/advenced-sheet.png'; // Sprite sheet dosya yolunu burada belirtin
    spriteSheet.onload = () => {
        initializeAdvancedMode(spriteSheet); // Sprite sheet yüklendikten sonra initializeClassicMode çağrılır
    };
